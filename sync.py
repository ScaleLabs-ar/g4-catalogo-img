#!/usr/bin/env python3
"""Reconstruye el catalogo brandeado de G4 Descartables: hornea lo nuevo y reescribe el feed.
...
TIENDA   = "https://www.g4descartables.com.ar"
BASE_IMG = "https://scalelabs-ar.github.io/g4-catalogo-img/img/"
DIR      = os.path.dirname(os.path.abspath(__file__))
IMGS     = os.path.join(DIR, "img")
MARCO    = os.path.join(DIR, "marco.png")
UA       = {"User-Agent": "Mozilla/5.0"}

# Banda libre entre el header del marco y la pildora de arriba. Medida sobre
# marco.png. Este marco NO tiene barra de pie —solo dos pildoras apiladas abajo
# a la izquierda— asi que la banda llega mas abajo que la de Plyrap.
LIENZO, TOP, BOT = 1080, 262, 880
...
def hornear(url, marco):
    ...
    caja = BOT - TOP
    esc  = min(round(LIENZO * 0.88) / foto.width, caja / foto.height)
